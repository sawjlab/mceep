...
C -----------------------------------------------------------------------
C
      SUBROUTINE MAD12(x_tg,x_fp,fail_apertures)
      IMPLICIT NONE
C
      DOUBLE PRECISION x_tg(6),x_fp(6)
      DOUBLE PRECISION mag1_radius,mag2_radius
      DOUBLE PRECISION x1,t1,y1,p1,l1
      DOUBLE PRECISION xoffset(11)  ! central ray location wrt magnet axis
      REAL x(5)
      REAL x_m12_0_2, t_m12_0_2, y_m12_0_2, p_m12_0_2, l_m12_0_2
                                          !entrance of mag1
      REAL x_m12_0_3, t_m12_0_3, y_m12_0_3, p_m12_0_3, l_m12_0_3
                                          !middle   of mag1
      REAL x_m12_0_4, t_m12_0_4, y_m12_0_4, p_m12_0_4, l_m12_0_4
                                          !exit     of mag1
      REAL x_m12_0_5, t_m12_0_5, y_m12_0_5, p_m12_0_5, l_m12_0_5
                                          !entrance of mag2
      REAL x_m12_0_7, t_m12_0_7, y_m12_0_7, p_m12_0_7, l_m12_0_7
                                          !middle   of mag2
      REAL x_m12_0_9, t_m12_0_9, y_m12_0_9, p_m12_0_9, l_m12_0_9
                                          !exit     of mag2
      REAL x_m12_0_11,t_m12_0_11,y_m12_0_11,p_m12_0_11,l_m12_0_11
...
C -----------------------------------------------------------------------
C
      DATA xoffset /0.d-3,-0.666043d-3,104.630898d-3,-73.731644d-3,
     #            11.757298d-3,0.d-3,156.909363d-3,0.d-3,-26.31488d-3,
     #            0.d-3,-151.757401d-3/                        ! in m
C
C -----------------------------------------------------------------------
...
C -----------------------------------------------------------------------
C
      x1 = DBLE(x_m12_0_2(x,5)) + xoffset(2)            ! mag1 entrance
      y1 = DBLE(y_m12_0_2(x,5))
...
C -------------------------------------------------------------
      x1 = DBLE(x_m12_0_3(x,5)) + xoffset(3)            ! mag1 middle
      y1 = DBLE(y_m12_0_3(x,5))
      if(x1*x1+y1*y1 .gt. mag1_radius*mag1_radius
...
C -------------------------------------------------------------
      x1 = DBLE(x_m12_0_4(x,5)) + xoffset(4)            ! mag1 exit
      y1 = DBLE(y_m12_0_4(x,5))
      if(x1*x1+y1*y1 .gt. mag1_radius*mag1_radius
...
C -------------------------------------------------------------
      x1 = DBLE(x_m12_0_5(x,5)) + xoffset(5)            ! mag2 entrance
      y1 = DBLE(y_m12_0_5(x,5))
...
C -------------------------------------------------------------
      x1 = DBLE(x_m12_0_7(x,5)) + xoffset(7)            ! mag2 middle
      y1 = DBLE(y_m12_0_7(x,5))
      if(x1*x1+y1*y1 .gt. mag2_radius*mag2_radius
...
C -------------------------------------------------------------
      x1 = DBLE(x_m12_0_9(x,5)) + xoffset(9)            ! mag2 exit
      y1 = DBLE(y_m12_0_9(x,5))
      if(x1*x1+y1*y1 .gt. mag2_radius*mag2_radius
...
C -----------------------------------------------------------------------
C
      x1 = DBLE(x_m12_0_11(x,5))             ! mad focal plane
      t1 = DBLE(t_m12_0_11(x,5))
      y1 = DBLE(y_m12_0_11(x,5))
      p1 = DBLE(p_m12_0_11(x,5))
      l1 = DBLE(l_m12_0_11(x,5))
C
C -----------------------------------------------------------------------
